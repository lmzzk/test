...
//    'DEFAULT_FILTER'        =>  array('strip_tags', 'htmlspecialchars','trim','addslashes'), // 默认参数过滤方法 用于I函数...
    ...
    /* 错误设置 */
    'ERROR_MESSAGE'         =>  '页面错误！请稍后再试1～',//错误显示信息,非调试模式有效
    'ERROR_PAGE'            =>  '',	// 错误定向页面
...
//    'TMPL_EXCEPTION_FILE'   =>  './Public/404/404.html',// 异常页面的模板文件
