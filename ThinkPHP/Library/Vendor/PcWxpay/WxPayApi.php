...
class WxPayConfig
{
	 ...
	 */
     ...
     //构造方法
     function __construct($APPID,$MCHID,$KEY,$APPSECRET,$NOTIFY_URL) 
     {
        $this::$APPID = $APPID;
        $this::$MCHID = $MCHID;
        $this::$KEY = $KEY;
	...
	const APPID      = 'wx5842274af4e1cf05';
    
    const MCHID      = '1484477612';
    
	const KEY        = '53c1547146f1b4b9669931be014b2477';
    
	const APPSECRET  = 'e05a5551b1d8207508b41223f0ba23e2';
    
    //const NOTIFY_URL ='http://gx.0900.cc/zoo/Home/Paynotify/notify';
	//=======【证书路径设置】=====================================
	/**
	 * TODO：设置商户证书路径
